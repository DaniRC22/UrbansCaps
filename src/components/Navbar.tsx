...
export default function Navbar() {
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-5 sm:px-8 md:px-[5%]"
      style={{
        height: '72px',
    ...
    >
      <a href="#hero" className="flex-shrink-0">
        <img src={logo} alt="Urbans Caps" style={{ height: '48px', width: 'auto', objectFit: 'contain' }} />
      </a>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex md:hidden items-center gap-2 text-xs font-black tracking-widest uppercase px-4 py-2 rounded"
        style={{ background: '#D4A017', color: '#000' }}
      >
